...
VOICES = [
  ...
  {"id":"owners","name":"Traditional Owners","person":"Wattle Bay Traditional Owners","avatar":"country","colour":"#7c3aed",
   "focus":[8],
   "shortRole":"Speaks for Country and the significant site",
   "concern":"The river mouth is a significant site. Tap to see what matters to us.",
  ...
  {"id":"eco","name":"Marine ecologist","person":"Dr Hannah Cole","avatar":"eco","colour":"#237a3b",
   "focus":[6,8,9],
   "shortRole":"Monitors the coast's natural health",
  ...
  {"id":"town","name":"Tourism and residents","person":"Sam Doyle","avatar":"town","colour":"#b35a1f",
   "focus":[3,5,7],
   "shortRole":"Runs the beach cafe; speaks for locals",
...
VOICE_DETAIL = {
  ...
  "town":{
    ...
    "roadRetreated":"We had to give up Cliff Road -- moved back, or just gone. The community built that road and people depend on it.",
...
QUESTIONS = [
  {"n":1, "tie":"Processes (4.2 / 4.3)",
   "q":"Which parts of the coastline changed the most over the 30 years? Explain why those places changed faster than others.",
   "lookFor":["headland","bay","cliff","wave energy","sheltered","exposed","erosion","deposition","longshore","drift","beach"],
   "selfcheck":"A strong answer points to specific features (exposed headland or cliff versus sheltered bay) and links the shape of the coast to how hard the waves hit -- not just names the place, but explains the process."},
  {"n":2, "tie":"Trade-offs (4.2)",
   "q":"Describe the hardest choice you had to make. What did you gain from that decision, and what did you give up?",
   "lookFor":["wall","retreat","nourish","protect","beach","sand","natural","cost","concrete","erosion","damage"],
   "selfcheck":"A strong answer names the decision, explains what it protected or improved, and is honest about the downside -- not just what worked, but what it cost or what it harmed."},
  {"n":3, "tie":"Competing values (4.2 / 4.5)",
   "q":"Your three advisers did not always agree. What made it hard to keep all of them happy at the same time?",
   "lookFor":["traditional owners","ecology","town","river mouth","wall","beach","concrete","natural","estuary","habitat","sand"],
   "selfcheck":"A strong answer identifies at least two competing interests and explains why satisfying one made it harder to satisfy another -- not just lists them, but shows the actual conflict."},
  {"n":4, "tie":"Advice and reasoning (4.5)",
   "q":"Based on what you saw, what is the most important piece of advice you would give a real coastal council? Explain your reasoning.",
   "lookFor":["risk","erosion","distance","setback","build","cliff","natural","long","future","community","plan"],
   "selfcheck":"A strong answer draws directly on what happened in the simulation to support the advice -- not a general statement, but something specific that the 30 years showed."},
]
